...
Its ugly and verbose, but it works.
...
heres a good read on what is going on under the helful gaze of defpackage https://flownet.com/gat/packages.pdf
...
Then any packages that use asdf for compilation or deployment, gain discovery as well
When your build system can do deployment and discovery, its pretty slick.
