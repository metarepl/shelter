...
** Packages and imports
  ...
  - a container to group symbols together
    ...
    - #:some-name vs :some-name dont worry to much about this, just know that :some-name always creates a symbol and #:some-name doesnt so #: keeps packages less cluttered
